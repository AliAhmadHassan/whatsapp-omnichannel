...
namespace NewWhats.DAL.Enfileramento
{
    public static class Enviar_Mensagem
    {
        public static void enfilera(DTO.MensagemEnvio mensagem, string telefone_orcozol)
        {
            ...
            msg.Body = mensagem;
            MessageQueue msgQ = new MessageQueue(string.Format(".\\private$\\{0}_NewWhats_Enviar_Mensagem", telefone_orcozol));
            msgQ.Send(msg);
        }
        ...
        public static List<DTO.MensagemEnvio> recolhe(string telefone_orcozol)
        {
            ...
            using (MessageQueue messageQueue = new MessageQueue(string.Format(".\\private$\\{0}_NewWhats_Enviar_Mensagem", telefone_orcozol)))
            {
